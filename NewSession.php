...
<tr>
<td> <h1> Create a new world? </h1></td>
</tr>
<tr>
<td> <font> When you create a new world you will create a new game session for you to join. You may invite other players to join this session, and compete for dominance over your world.</font>
<br>
<font> When creating your world you will recieve a join code - enter this code in the "Join a session" tab to join your world and recieve your login. Send this code to your friends to play with eachother!</font></td>
</tr>
<tr>
<td>
<br><br><br>
<button id="BackButton" style="background-color:green;color: white;text-align: center;display: inline-block;font-size: 32px;margin: 4px 2px;cursor: pointer;width:600px;height:90px;border:none;font-family:'Helvetica';float:center;" onclick="document.location='index.php'"> Generate a new Session </button>
</td>
</tr>
</table>
</div>
