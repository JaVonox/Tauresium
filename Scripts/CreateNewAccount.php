...
$worldCode = (!ctype_alnum($_POST['WorldCodeInput'])? "NULL" : (empty($_POST['WorldCodeInput']) ? "NULL" : $_POST['WorldCodeInput']) );
$countryName = (!ctype_alnum($_POST['CountryNameInput']) ? "NULL" : (empty($_POST['CountryNameInput']) ? "NULL" : $_POST['CountryNameInput']));
$countryPass = (empty($_POST['CountryPassInput']) ? "NULL" : $_POST['CountryPassInput'] );
