...
class ProvinceHighDetail
{
    ...
    public function __construct($Province_ID, $Capital, $Region,$Vert1,$Vert2,$Vert3, $Climate, $City_Population_Total,$National_HDI,$National_Nominal_GDP_per_capita,$Coastal,$Coastal_Region,$Owner,$Build1,$Build2,$Culture_Cost,$Economic_Cost,$Military_Cost,$Description,$Culture_Modifier,$Economic_Enviroment_Modifier,$Military_Enviroment_Modifier)
    {
        $this->Province_ID = $Province_ID;
        $this->Capital = $Capital;
        $this->Region = $Region;
...
class PlayerDetail
{
    ...
    public function __construct($Country_Name,$Country_Type,$Colour,$World_Code,$Military_Influence,$Military_Generation,$Culture_Influence,$Culture_Generation,$Economic_Influence,$Economic_Generation,$Events_Stacked,$Last_Event_Time,$Active_Event_ID,$Provinces)
    {
