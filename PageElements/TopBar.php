...
<div id="MenuBar" style="background-color:#E4E4E4;width:100%;height:40px;border-bottom:4px solid black;overflow:auto;"> 
	...
	<button class="eventsButton" <?php echo (floor($playerStats['Events_Stacked']) >= 1) ? "onclick=" . '"' . "document.location='LoadEvent.php'" . '"' : "style='pointer-events:none;visibility:hidden;'" ?> >Events (<?php echo floor($playerStats['Events_Stacked']) ?>)</button>
</div>
